...
package org.eclipse.tracecompass.incubator.overhead.core.tests;
...
import org.eclipse.tracecompass.incubator.internal.overhead.core.Activator;
...
public class ActivatorTest extends Plugin {
     ...
     * The plug-in ID
     */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.incubator.overhead.core.tests"; //$NON-NLS-1$
    ...
    public void testActivator() {
        ...
        assertEquals("org.eclipse.tracecompass.incubator.overhead.core", instance.getPluginId());
    }
