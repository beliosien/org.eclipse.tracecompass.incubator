...
package org.eclipse.tracecompass.incubator.overhead.ui.view.data.provider;
...
public class KvmExitDensityView extends TmfChartView {
    /** View ID */
    public static final String ID = "org.eclipse.tracecompass.overhead.dataprovider.xyview"; //$NON-NLS-1$
