...
import org.eclipse.tracecompass.incubator.overhead.core.data.provider.VMNativeTimeGraphDataProvider;
...
public class VMNativeComparisonView extends BaseDataProviderTimeGraphView {
    ...
    public static final String ID = "org.eclipse.tracecompass.analysis.vmcomparison.ui.view2"; //$NON-NLS-1$
